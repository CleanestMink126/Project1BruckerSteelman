...
**Figure 5.** The proportion of successful messages in the network as a function of the payoff, *b*, and the initial proportion of cooperating nodes, *C0*. Simulated with 10 steps on a network with *N* = 200, *gamma* = 2.5, and mean degree of 6.
